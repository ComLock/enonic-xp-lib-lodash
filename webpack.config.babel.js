...
const NODE_MODULES_DIR_ABS = path.resolve(__dirname, 'node_modules');

const DST_DIR = 'build/resources/main';
//const DST_DIR_ABS = path.join(__dirname, DST_DIR);
const DST_LIB_DIR_ABS = path.join(__dirname, DST_DIR, 'lib');
